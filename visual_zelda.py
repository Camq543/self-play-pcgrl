...
####### REWARD PLOT #######
d = open("logs\zelda_narrow_negative_switch_log.txt", "r") #CHANGE THIS
...
plt.plot(x_valc, ysmoothed_1c, label = "Narrow Negative Switch (Agent 1)", color = "#5899DA")
plt.plot(x_valc, ysmoothed_2c, label = "Narrow Negative Switch (Agent 2)", color = "#5899DA", linestyle='--')
...
####### KEY PLOT #######
h = open("logs\zelda_narrow_log.txt", "r") #CHANGE THIS
...
#plt.figure(figsize=(12,9))
plt.plot(x_valc, ysmoothed_1c, label = "Narrow (Agent 1)", color = '#E8743B')
plt.plot(x_valc, ysmoothed_2c, label = "Narrow (Agent 2)", color = '#E8743B', linestyle='--')
...
####### KEY PLOT #######
h = open("logs\zelda_turtle_log.txt", "r") #CHANGE THIS
...
#plt.figure(figsize=(12,9))
plt.plot(x_valc, ysmoothed_1c, label = "Turtle (Agent 1)", color = '#19A979')
plt.plot(x_valc, ysmoothed_2c, label = "Turtle (Agent 2)", color = '#19A979', linestyle='--')
...
####### KEY PLOT #######
h = open("logs\zelda_turtle_negative_switch_log.txt", "r") #CHANGE THIS
...
####### DOOR PLOT #######
j = open("logs\zelda_turtle_map_restricted_log.txt", "r") #CHANGE THIS
...
#plt.figure(figsize=(12,9))
plt.plot(x_valc, ysmoothed_1c, label = "Turtle Map Restricted  (Agent 1)", color = '#945ECF')
plt.plot(x_valc, ysmoothed_2c, label = "Turtle Map Restricted (Agent 2)", color = '#945ECF', linestyle='--')

plt.title("Base - Zelda") #CHANGE THIS
plt.legend(loc="lower right")
plt.xlabel('Update Interval')
plt.ylabel('Reward Values') #CHANGE THIS

strFile = "./figs/base_zelda.png" #CHANGE THIS
if os.path.isfile(strFile):
  os.remove(strFile)
plt.savefig(strFile)
plt.show()
